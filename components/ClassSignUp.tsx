      ...
      {signed
        ? (
          <>
            ...
            <button type="button" className="text-center text-white text-xs font-black uppercase tracking-wide rounded-md bg-orange-200 px-2 py-1 mt-2" onClick={cancelSignUp}>Cancel</button>
          </>
        )
