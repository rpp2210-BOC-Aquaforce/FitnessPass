...
function TextDiv({ children }: TextDivProps) {
  return <div className="text-seafoam text-xs pt-1 font-black uppercase tracking-wide">{children}</div>;
}

export default function Card() {
  return (
    <div className="flex items-start mt-4 bg-white w-full h-[104px]">
      <img className="h-full w-[116.60px] object-cover" src="https://via.placeholder.com/117x104" alt="Placeholder" />
      <div className="flex flex-col justify-between ml-4 flex-grow">
        <TextDiv>Fit People SF</TextDiv>
        <TextDiv>9:00a.m. (60 min)</TextDiv>
        <TextDiv>San Francisco</TextDiv>
        <TextDiv>Ratings</TextDiv>
      </div>
